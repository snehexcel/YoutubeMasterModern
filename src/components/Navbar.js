...
const Navbar = () => {
  ...
  return (
    <div className="bg-yt-black h-14 flex items-center pl-4 pr-5 justify-between fixed w-full z-10">
      ...
      <div className="h-10 flex flex-row items-center flex-grow">
        <div className="w-full lg:w-[593px] bg-yt-black flex border border-yt-light-black items-center rounded-3xl h-10">
          <input
            type="text"
            placeholder="Search"
            className="w-full bg-yt-black h-6 lg:h-10 ml-6 lg:ml-0 text-yt-white text-start focus:outline-none pl-4"
          />
          <button className="w-16 h-10 lg:h-10 bg-yt-light-black px-2 py-0.5 lg:px-3 lg:py-1 rounded-r-3xl lg:rounded-full border-l-2 border-yt-light-black">
            <HiMagnifyingGlass
              size={22}
      ...
      <div className="flex items-center justify-center">
        <div className="flex flex-row items-center">
          <div className="mr-2 p-2 w-10 lg:w-12 hover:bg-yt-light-black rounded-full cursor-pointer">
            <BiVideoPlus size={25} className="text-yt-white text-center" />
          </div>
          <div className="mx-3 p-2 w-10 lg:w-12 hover:bg-yt-light-black rounded-full cursor-pointer">
          ...
          <div className="mx-3 items-center cursor-pointer">
            {!user ? (
              ...
              <img
                ...
                className="object-contain rounded-full cursor-pointer w-10 h-10 lg:w-12 lg:h-12"
              />
            )}
          </div>
        </div>
