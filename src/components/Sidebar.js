...
const Sidebar = () => {
  ...
  return (
    <div className="yt-scrollbar scrollbar-hide w-60 bg-yt-black h-[calc(100vh-53px)] mt-14 fixed top-0 left-0 text-yt-white p-3 overflow-scroll">
      {/* Top item are mapped here home shorts and Subscriptions */}
      <div className="mb-4">
      ...
      {/* Middle SlideBar Items are placed here Library History, Your Videos, Watch Later and Liked videos */}
      <div className="mb-4">
